...
# Syscoin
DEFINES += BTCHIP_P2PKH_VERSION=63 BTCHIP_P2SH_VERSION=5 BTCHIP_COIN_FAMILY=1 BTCHIP_COINID=\"Syscoin\" COINID_UPCASE=\"SYSCOIN\" COLOR_HDR=0xFCB653 COLOR_DB=0xFEDBA9 COINID_NAME=\"Syscoin\" COINID=$(COIN) BTCHIP_COINID_SHORT=\"SYS\" COIN_SYSCOIN
APPNAME ="Syscoin"
else
